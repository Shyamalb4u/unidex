...
export default function Wallet() {
  ...
  return (
    <>
      <div className="container bg-n900 relative overflow-hidden flex justify-start items-start text-white pb-36 h-full">
        ...
        <div className="relative z-20 w-full">
          <div className="bg-white bg-opacity-5 py-4 px-6 rounded-b-3xl">
            ...
            <div className="flex justify-between items-start">
              ...
              <div className="items-center">
                <button
                  className="block bg-g300 font-semibold text-center py-3 px-3 rounded-lg openAgreeModal w-full"
          ...
          <div className="fixed left-0 right-0 bottom-0">
            <div className="container relative bg-white bg-opacity-5 py-5 flex justify-around items-center after:absolute after:bg-n700 after:inset-0">
              <div
                className="absolute left-[41%] bottom-[72px] z-40"
                onClick={() => fetchIncomeData(address)}
              >
                <div className="bg-g300 text-2xl p-3.5 rounded-full flex justify-center items-center relative">
